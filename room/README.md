...
# Usage
To try out the experience, please visit this link! https://tkhuu-umb.github.io/cs460student/room/
...
# Known Issues
> *Sometimes when I move, it will continue in that direction after I let go. How do I stop that?*

Occasionally, when multiple keys are pressed at once and then released, it may fail to register one of the key releases, causing a “stuck” movement. If this happens, simply press the key corresponding to the stuck direction (for example, press **D** if you’re stuck moving right) to fix it.

> *My cursor is no longer attached to the experience. How do I reattach myself?*
...
# Acknowledgements
### Models
All models featured in this scene were sourced from **[Sketchfab](https://sketchfab.com/)**, a popular platform for sharing 3D assets. I would like to thank the following creators for making their work publicly available:

* Abacus - pamruta
* Children’s building blocks toy - Chenchanchong
* Cake - Akshat
* Detailed Beer Case - Zbrojmistrz
* Basketball Hoop - agamoud
* Vintage painting, Dani - theGentleGiant
* Painting by Zdzislaw Beksinski (3) - Sebastian Sosnowski
* Painting Lowpoly - BaptisteBerard
* Victorian Framed Painting - PBR Game Ready - Matthew Collings
* Big painting - amapola.r
* rails - morff
* Assignment 5 Half Pipe - charlotteyang007
* Happy Birthday Sign - Duznot
* Snake Statue - Ville Seppänen
* No Way Home Spider-Man - Shadatorr
* Creepy Sponge - kiha
* Gold Star - AnshiNoWara
* FNAF SB Bar Table With Chairs - Ace-Jane
